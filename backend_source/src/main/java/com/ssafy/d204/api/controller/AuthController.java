...
public class AuthController extends SuperController{
	...
	public ResponseEntity<?> register(@RequestBody UserRegisterPostReq registerInfo) throws Exception{
		try {
...
//			System.out.println(UserFieldValidator.emailValidation(registerInfo.getEmail()));
	...
	public ResponseEntity<?> checkEmail(@RequestBody DuplicateCheckEmailPostReq email) throws Exception{
		try {
